...
def write_keypoints_to_disk_edited(filename, kpts):
    with open(filename, 'w') as fout:
        for frame_kpts in kpts:
            for kpt in frame_kpts:
                if len(kpt) == 5:
                    fout.write(str(kpt[0]) + ' ' + str(kpt[1]) + ' ' + str(kpt[2]) + ' ' + str(kpt[3]) + ' ' + str(kpt[4]) + ' ')
                else:
                    fout.write(str(kpt[0]) + ' ' + str(kpt[1]) + ' ' + str(kpt[2]) + ' ')
...
def write_keypoints_to_disk_og(filename, kpts):
